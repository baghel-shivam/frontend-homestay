    ...
    <div className='d-flex justify-content-center align-content-around' style={{ minHeight: '120vh', marginTop: '1.5rem' }}>
      <div id="monal-img-container" className=''>
        ...
        <div className="monal-content">
          ...
          <strong>The Himalayan Monal (Lophophorus impejanus)</strong> is a colorful bird native to the Himalayas and parts of central Asia, including regions in India, Nepal, Bhutan, and Tibet.
          ...
          In addition to its beauty, the Himalayan Monal plays a significant ecological role as a seed disperser and helps maintain the balance of its mountainous habitat.
