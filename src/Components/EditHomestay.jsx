...
export default function EditHomestay() {
    ...
    const handleRoomChanges = (e, rowindex) =>{
        const {name, value} = e.target;
                            ...
                            <div className="mt-2">
                                <div className="col-12 text-left row">
                                    <div className="mb-3 col-sm-6">
                                        ...
                                        <input name="contact_phn" onChange={handleChange} value={homestayData?.homestayObj?.contact_phn} type="number" className="form-control" id="contact_phn" />
                                    </div>
                                    <div className="mb-3 col-sm-6">
                                        <label htmlFor="upi_phn_no">UPI Phone No:</label>
                                        <input name="upi_phn_no" onChange={handleChange} value={homestayData?.homestayObj?.upi_phn_no} type="number" className="form-control" id="upi_phn_no" />
                                    </div>
