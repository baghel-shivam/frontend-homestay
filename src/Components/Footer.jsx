            ...
            <div className="d-flex flex-column text-start " style={{ cursor: 'pointer', padding: 0, color: '#00000' }}>
              <div className="d-flex mt-4 mx-auto" style={{ width: '100%', color: '#00000' }}>
                ...
                <button className="btn btn-dark btn-flat px-3 mx-2">
                  <a href="https://www.facebook.com/your-facebook" className='text-light'>  <i className="bi bi-facebook"></i></a>
                </button>
                <button className="btn btn-dark btn-flat px-3 mx-2">
                  <i className="bi bi-twitter-x" ></i>
                </button>
                <button className="btn btn-dark btn-flat px-3 mx-2">
                  <a href="https://www.instagram.com/your-instagram" className='text-light'> <i className="bi bi-instagram"></i></a>
                </button>
              </div>
            </div>
          </div>
